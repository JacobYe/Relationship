...
wvDict = {
    ...
    "./csv/Breakup0623-509.csv": "./vec/Breakup0623-509.vec",
    "./csv/Crush0622-391.csv": "./vec/Crush0622-391.vec",
    "./csv/Crush0623-650.csv": "./vec/Crush0623-650.vec",
    "./csv/Divorce0622-46.csv": "./vec/Divorce0622-46.vec",
    "./csv/Divorce0623-350.csv": "./vec/Divorce0623-350.vec",
    "./csv/Love0622-2100.csv": "./vec/Love0622-2100.vec",
    "./csv/Love0623-1246.csv": "./vec/Love0623-1246.vec",
    ...
    "./csv/Single0623-450.csv": "./vec/Single0623-450.vec"
}
